...
def main():
    ...
    # input and output
    parser.add_argument('--input_dir', default='./dynamic_bart_kopl/preprocessed_data')  # 调试的时候路径用一个点，在下方终端Bart_Program下运行用两个点，对于这个项目要想统一，看should_read.md文件
    parser.add_argument('--save_dir', default='./dynamic_bart_kopl/output/predict_result', help='path to save checkpoints and logs')
    
    parser.add_argument('--ckpt',  default='./dynamic_bart_kopl/output/checkpoint/checkpoint-best')
