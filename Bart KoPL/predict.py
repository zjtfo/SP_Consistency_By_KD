...
def main():
    ...
    parser.add_argument('--save_dir', default='./transfer_based_golden_label/output_hybrid_raw/predict_result_147475', help='path to save checkpoints and logs')
    parser.add_argument('--ckpt', default='./transfer_based_golden_label/output_hybrid_raw/checkpoint/checkpoint-147475')
