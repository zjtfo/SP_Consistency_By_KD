...
# 单机多卡
def validate(args, kb, model, data, tokenizer):
    model.eval()
    count, correct = 0, 0
    with torch.no_grad():
        all_outputs = []
...
def main():
    ...
    parser.add_argument('--save_dir', default='./dynamic_bart_sparql/output/predict_result', help='path to save checkpoints and logs')
    parser.add_argument('--ckpt', default='./dynamic_bart_sparql/output/checkpoint/checkpoint-best')
