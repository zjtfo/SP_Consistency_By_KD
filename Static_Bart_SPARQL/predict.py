...
def main():
    ...
    parser.add_argument('--save_dir', default='./static_bart_sparql/output/predict_result', help='path to save checkpoints and logs')
    parser.add_argument('--ckpt', default='./static_bart_sparql/output/checkpoint/checkpoint-best')
