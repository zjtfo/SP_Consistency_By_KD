...
class RuleExecutor(object):
    def __init__(self, vocab, kb_json):
        self.vocab = vocab  # answer_token_to_idx和answer_idx_to_token两个都有的
        print('load kb')
        ...
        # 下面几行就是将知识库中concepts中name和id对应起来，entities中name和id对应起来
        ...
        # 有些实体可能与概念有关系，我们将它们添加到self.concepts中。概念是为了访问方便
        for ent_id in self.entities:
